...
export default function ChildExamsPage() {
  ...
  // Filtrage côté client pour le statut (basé sur reflet_pupillaire et fo)
  const filteredExams =
    statusFilter === 'all'
      ? exams
      : exams.filter((exam) => {
          const isComplete = exam.reflet_pupillaire && exam.fo;
        ...
        <>
                    ...
                    return (
                      <TableRow key={exam.id}>
                        ...
                        <TableCell>
                          <Badge
                            variant={
                              exam.reflet_pupillaire === 'normal'
                                ? 'outline'
                                : exam.reflet_pupillaire === 'anormal'
                                  ? 'destructive'
                                  : 'secondary'
                            }
                            className="text-xs"
                          >
                            {exam.reflet_pupillaire ?? 'Non évalué'}
                          </Badge>
                        </TableCell>
                        <TableCell>
                          <Badge
          ...
          <div className="mt-4 flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Affichage de {filteredExams.length} sur {totalCount} examens
            </p>
