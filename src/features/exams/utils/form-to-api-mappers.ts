...
export const mapRefractionFormToApi = (data: Refraction) => {
  ...
  return {
    correction_prescrite: correction,
    ...
    avodg_avec_correction_prescrite: toFixedDecimalString(avodgAvecCorrection),
    addition_od: toFixedDecimalString(data.addition_od),
    addition_og: toFixedDecimalString(data.addition_og),
