...
export function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div
        role="alert"
        className="rounded-lg border border-red-500/30 bg-red-50 px-4 py-3 text-sm text-red-600 dark:bg-red-500/10 dark:text-red-300"
      >
